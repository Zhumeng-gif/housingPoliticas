...
css2021$housesource <- css2021$c1d1
css2021$houselocation <- css2021$c1e1
css2021$houseby_year <- Recode(css2021$c1f1,"-1:201 = NA")
...
fulldata <- merge(css2021,China,by.x = "city_name",by.y = "Name_Perfecture",all.x = TRUE) 
