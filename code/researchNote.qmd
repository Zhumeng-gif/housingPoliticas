...
css2021 <- merge(css2021_raw,cityname,by.x = "city_code", by.y="city_code", all.x = TRUE) %>%
  select(.,v2,v1,city_code,city_name,v3_1,year,a1,a1b1,a1c1,a1d1,a1e1,a2,a3,a4a,a4g,b1,b3,c1a,c1b1,c1c1,c1d1,c1e1,c1f1,c1g1,c1h1,c5a1,c6a,c6b,e1a,e2a,d4a,d4b,d4c,f1a_1,f1a_2,f1a_3,f1a_9,g1a_1,g1a_2,g1a_4,g1a_5,g1a_6,g1b_1,g1b_3,g1b_4,g1b_5,g1b_6,g3a_1,g3a_2,g3a_3,g3a_4,g3a_5,g3a_6,g3a_7,g3a_8,g3a_9,g3a_10,g3a_11,g3a_12,g3a_13,g3a_14,g3a_15,h2a_1,h2a_2,h2a_3,h2a_4,h2a_5,h2a_6,h2a_7,h2a_8,h2a_9,h2a_11,h3b,h4,h5a,h6a_1,h6a_2,h6a_3,h6a_4,h6a_5,h6a_6,h6a_8)
...
css2021$houseownr <- Recode(css2021$c1a,"1:11 = 1; -2:-1 = NA") 
css2021$housesize <- css2021$c1b1
css2021$housetype <- Recode(css2021$c1c1,"1 = 1; 3:4 = 2; c(5,7) = 3; c(2,6) = 4; 8 = NA") 
...
css2021$politicalTotal <- dplyr::select(css2021,h2a_1,h2a_2,h2a_3,h2a_4,h2a_5,h2a_6,h2a_7,h2a_8,h2a_11) %>%
  rowMeans(na.rm = TRUE)
css2021$politicalDiuss <- dplyr::select(css2021,h2a_1,h2a_2,h2a_3)%>%
  rowMeans(na.rm = TRUE)
css2021$politicalEffect <- dplyr::select(css2021,h2a_4,h2a_5,h2a_6,h2a_8) %>%
  rowMeans(na.rm = TRUE)
css2021$politicalCollect <- dplyr::select(css2021,h2a_7,h2a_11) %>%
  rowMeans(na.rm = TRUE)
css2021$politicalVote <- css2021$h4 #是否愿意参加下次一社区军委会/村委会选举

### political vote
css2021$votessu <- Recode(css2021$h3b,"2 = 0; 3 = NA")
css2021$votepku <- Recode(css2021$h5a,"2 = 0; 3:4 = NA")
...
```{r regression}
lm_own <-  lm(trust_local_z ~  housetype + housetype + age + female + edu + party + hukouRural + marriage + socialLevel + log(incomeFam + 0.01) + job + as.factor(houselocation),data = fulldata)
lmer_own <-  lmer(trust_local_z ~ 1 + (1|city_code) + housetype + houselocation + housetype * houselocation + priceCom + age + female + race + edu + party + marriage + hukouRural + socialLevel + log(incomeFam + 0.01) + job + as.factor(houseby_year),data = fulldata)
